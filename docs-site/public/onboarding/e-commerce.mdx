...
- **[Settlement rules](/api-reference/openapi)** — automatic fee splits (e.g. 2.5% platform fee → another account)
- **[Refunds](/api-reference/openapi)** — full or partial reversal of completed checkouts
- **[Disputes](/api-reference/openapi)** — chargeback handling
