...
<CardGroup cols={2}>
  <Card title="Email support" icon="envelope" href="mailto:hello@getsly.ai">
    `hello@getsly.ai` — integration questions, account issues, anything with a request ID.
  </Card>
  <Card title="Docs GitHub" icon="github" href="https://github.com/Sly-devs/sly/issues">
    Open an issue for docs errors, typos, or missing content.
  </Card>
  <Card title="Dashboard chat" icon="comment" href="https://app.getsly.ai">
    Intercom chat inside the dashboard, bottom-right. Fastest for account-specific issues.
  </Card>
  <Card title="Status" icon="heart-pulse" href="/resources/status">
    Platform status + incident history. Public status page [coming soon](/resources/coming-soon).
  </Card>
</CardGroup>
